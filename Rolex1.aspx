<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rolex1.aspx.cs" Inherits="minuk_project.Rolex1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="롤렉스 알아보기"></asp:Label>
        </div>
        <div>
            <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="유명 아날로그 시계"></asp:Label>
            <br />
        </div>
        <p>
